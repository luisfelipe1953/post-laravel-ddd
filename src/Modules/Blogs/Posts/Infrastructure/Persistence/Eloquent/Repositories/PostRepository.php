...
namespace Src\Modules\Blogs\Posts\Infrastructure\Persistence\Eloquent\Repositories;
...
use Src\Modules\Blogs\Posts\Domain\Model\ValueObjects\PostId;
use Src\Modules\Blogs\Posts\Domain\Model\ValueObjects\PostSlug;
...
class PostRepository implements PostRepositoryContract
{
    ...
    {
        $this->model = new PostEloquentModel;
    }
